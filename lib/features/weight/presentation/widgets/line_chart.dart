...
class _WeightLineChartState extends State<WeightLineChart> with SingleTickerProviderStateMixin {
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    DateFormat('MMM d, yyyy').format(_selectedEntry!.dateObject),
  ...
  LineChartBarData _buildLineChartBarData(List<WeightEntryEntity> entries, double animationValue) {
    final spots = <FlSpot>[];
